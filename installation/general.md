...
Red Hat, Debian, Ubuntu Linux
входит в дистрибутив ОС + репозиторий (yum, apt)
...
собрать сервер со специфичными параметрами
или на специфичной архитектуре
(этот способ попробуем на практике)
